...
const similarUserNameChecking = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield auth_service_1.AuthServices.userNameChecking(req.body);
    if (result.length > 0) {
        (0, sendResponse_1.sendResponse)(res, {
            success: true,
            message: "This username is too similar to existing usernames. Please choose a different one.",
            data: result,
        });
    }
    else {
